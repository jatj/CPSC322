...
\begin{enumerate}[label=(\alph*)]
    ...
    \begin{enumerate}[label=(\roman*)]
        ...
        \ans{
            ...
            (Maximum constraints solved) the algorithm is going to get stuck $50\%$  of the time 
            and fail to find a solution. This is because the solution can get stuck in a local minima. 
        ...
        \ans{
            ...
            constraints, but the advantage of this one is that it will always find a solution.
        }
        ...
        \ans{
            ...
            of the time. For this comparison we selected $50\%$ of the time the best node and $50\%$ a random 
    ...
    \ans{
<<<<<<< HEAD
        We chose method (ii). Results are consistent even though we are choosing random node with unsatisfied constraints, 
=======
        Results are consistent even though we are choosing a random node with unsatisfied constraints, 
>>>>>>> b4af745f5cf37a0a9c9eb81c2f529b246c2270b1
